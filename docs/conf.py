...
.. raw:: html
    ...
    <div class="admonition note">
      <p style="margin-bottom:0px">
        ...
        <a class="reference external" href="https://github.com/PlasmaPy/PlasmaPy/tree/{{ revision|e }}/{{ docname|e }}">{{ docname|e }}</a>.
        <br>
        Interactive online version:
        <a href="https://mybinder.org/v2/gh/PlasmaPy/PlasmaPy/tree/{{ revision|e }}/?filepath={{ docname|e }}"><img alt="Binder badge" src="https://mybinder.org/badge_logo.svg" style="vertical-align:text-bottom"></a>.
      </p>
    </div>
