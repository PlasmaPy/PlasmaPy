...
# ones. When extensions are removed or added, please update the
# documentation guide in the development guide.
extensions = [
    "sphinx.ext.autodoc",
...
# the documentation guide in the development guide.
intersphinx_mapping = {
...
# be used globally.
rst_epilog = ""
with open("common_links.rst", "r") as cl:
    rst_epilog += cl.read()
