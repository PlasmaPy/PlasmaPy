...
- Changed type annotations to be consistent with :pep:`604`. Most
...
- Changed type annotations that used `numbers.Integral`,
...
- Added and updated type annotations within `plasmapy.formulary`.
  (:pr:`2543`)
...
- Updated type annotations in `plasmapy.particles`. (:pr:`2458`)
