...
- Changed unit annotations to |Quantity| type annotations. (:pr:`2421`)
...
- Added a discussion of |type annotations| in the |testing guide|
...
- Added mypy to the suite of continuous integration
  checks. (:pr:`2432`)
- Used ``autotyping`` to implement |type annotations| for special
...
- Added a stub file containing |type annotations| for
...
- Added a :file:`py.typed` marker file to indicate that PlasmaPy
  contains type annotations as per :pep:`561`. (:pr:`2473`)
