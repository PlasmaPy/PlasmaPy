...
- Described the prototype plasma-calculator in the narrative
  documentation. (`#1390
...
- Updated the instructions on how to install PlasmaPy`. (`#1482
  <https://github.com/plasmapy/plasmapy/pull/1482>`__)
- Defined ``autodoc_typehints_format="short"`` so signature type annotations
...
- Changed the type annotations for ``z_mean`` in
