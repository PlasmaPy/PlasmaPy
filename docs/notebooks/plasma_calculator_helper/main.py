...
grid_data = [
    ...
    [
        ...
        *_create_widget(_FloatBox,property_name="B",unit=units.T,opts=[units.T,units.G,units.uG])
    ],
    [
        _create_label("Particle:"),
        _create_widget(_ParticleBox,property_name="particle",property_alias="particle_type",placeholder="Enter particle e.g. neutron,He")
    ],
    [
        _create_label("Ion:"),
        _create_widget(_IonBox,property_name="ion",property_alias="ion_type",placeholder="Enter ion e.g. He 2+")
    ],
    [
    ...
    [
        ...
        *_create_widget(_FloatBox,property_name="n",unit=units.m**-3,
            opts=[units.m**-3,units.cm**-3,units.mm**-3])
    ],
    [
        _create_label("n<sub>e</sub> - Electron Density Number:"),
        *_create_widget(_FloatBox,property_name="n_e",unit=units.m**-3,
            opts=[units.m**-3,units.cm**-3,units.mm**-3])
    ],
    [
        _create_label("n<sub>i</sub> - Ion Density Number:"),
        *_create_widget(_FloatBox,property_name="n_i",unit=units.m**-3,
            opts=[units.m**-3,units.cm**-3,units.mm**-3])
    ],
    [
        _create_label("_"*20,color=light_blue),
