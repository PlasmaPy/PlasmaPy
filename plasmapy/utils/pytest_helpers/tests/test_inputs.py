...
@pytest.mark.parametrize('function, args, kwargs, attribute, expected', [
...
@pytest.mark.parametrize("function, args, kwargs, expected", [
    (sample_function, sample_args, sample_kwargs, sample_function(*sample_args, **sample_kwargs)),
...
@pytest.mark.parametrize("cls, args, kwargs, expected", [
...
@pytest.mark.parametrize("cls, args, kwargs, attribute_of_cls", [
...
@pytest.mark.parametrize("cls, cls_args, cls_kwargs, method_args, method_kwargs, expected", [
...
@pytest.mark.parametrize("cls, cls_args, cls_kwargs, method_args, method_kwargs, method_name", [
    (*common_inputs, 42),
...
@pytest.mark.parametrize(
    "bad_kwargs, exception", [
        (bad_kwargs_wrong_type, TypeError),
        (bad_kwargs_nonstring_key, ValueError),
    ])
