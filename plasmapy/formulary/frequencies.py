...
def Buchsbaum_frequency(
    ...
    r"""
    Calculate the Buchsbaum frequency for a two-ion-species plasma (defaults to units of radians per second.)
    ...
    **Aliases:** `wbb_`, `wii_`, `wbi_`
    ...
    the bi-ion hybrid resonance frequency :cite:p: `thompson:1995` or ion-ion hybrid frequency
    ...
    omega_c1 = gyrofrequency(B, ion1, signed=False, Z=Z1)
    omega_c2 = gyrofrequency(B, ion2, signed=False, Z=Z2)
    omega_p1 = plasma_frequency(n1, ion1, z_mean=Z1)
    omega_p2 = plasma_frequency(n2, ion2, z_mean=Z2)
