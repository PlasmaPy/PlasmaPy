...
def test_running_mean(signal, radius: float, expected) -> None:
...
def test_running_mean_exception(signal, radius: float) -> None:
...
def test_running_moment(signal, radius: float, moment, time, expected) -> None:
...
def test_running_moment_exception(signal, radius: float, moment, time) -> None:
    """Test whether exception is risen"""
