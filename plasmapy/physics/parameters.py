...
def gyrofrequency(B: u.T, particle='e-', signed=False, Z=None, to_hz = False):
    ...
    to_hz : boolean, optional
        ...
        Default is 'False', if it is changed to True decorator from_radians_to_hz
        will convert it to Hertz.
    Returns
    -------
    omega_c : ~astropy.units.Quantity
        The particle gyrofrequency in units of radians per second or Hertz
    Raises
    ------
    TypeError
...
def plasma_frequency(n: u.m**-3, particle='e-', z_mean=None, to_hz = False):
    ...
    omega_p : ~astropy.units.Quantity
        The particle plasma frequency in radians per second or Hertz.
    Raises
    ------
    TypeError
...
def upper_hybrid_frequency(B: u.T, n_e: u.m**-3, to_hz = False):
    ...
    omega_uh : ~astropy.units.Quantity
        The upper hybrid frequency in radians per second or Hertz.
    Raises
    ------
    TypeError
...
def lower_hybrid_frequency(B, n_i, ion = 'p+', to_hz = False ):
    ...
    omega_lh : ~astropy.units.Quantity
        The lower hybrid frequency in radians per second or Hertz.
    Raises
    ------
    TypeError
