"""
Define MagneticStatics class to calculate common static magnetic fields(issue #100).
"""
...
class MagnetoStatics(abc.ABC):
    """
    Abstract class for `MagneticStatics` all kinds of magnetic static field
    """
...
class GeneralWire(Wire):
    ...
    """
    For simplicity, we segment the wire into n pieces by equally spaced parameter,
...
class FiniteStraightWire(Wire):
    """
    Finite length straight wire class. p1 to p2 direction is the possitive current direction.
