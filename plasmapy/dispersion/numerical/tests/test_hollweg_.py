...
class TestHollweg:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                {
                    "fast_mode": [[2.62804756e-02 + 0.0j, 2.62867114e-02 + 0.0j, 2.62911663e-02 + 0.0j], [4.53954617e03 + 0.0j, 3.40643523e03 + 0.0j, 2.27876968e03 + 0.0j]],
                    "alfven_mode": [[1.49661942e-03 + 0.0j, 1.12286371e-03 + 0.0j, 7.48765909e-04 + 0.0j], [2.14516382e03 + 0.0j, 2.14481201e03 + 0.0j, 2.13800404e03 + 0.0j]],
                    "acoustic_mode": [[0.00086572+0.j, 0.00064937+0.j, 0.00043295+0.j], [0.14735951+0.j, 0.11044097+0.j, 0.07358991+0.j]],
                },
            ),
        ],
    )
    def test_vals(self, kwargs, expected):
        ...
        for mode, val in ws.items():
            np.allclose(val.value, expected[mode])
