...
Elements = {
    ...
    "Tc": {"atomic_number": 43, "symbol": "Tc",
           "atomic_mass": None, "name": "technetium"},
    ...
    "Pm": {"atomic_number": 61, "symbol": "Pm",
           "atomic_mass": None, "name": "promethium"},
    ...
    "Po": {"atomic_number": 84, "symbol": "Po",
           "atomic_mass": None, "name": "polonium"},
    "At": {"atomic_number": 85, "symbol": "At",
           "atomic_mass": None, "name": "astatine"},
    "Rn": {"atomic_number": 86, "symbol": "Rn",
           "atomic_mass": None, "name": "radon"},
    "Fr": {"atomic_number": 87, "symbol": "Fr",
           "atomic_mass": None, "name": "francium"},
    "Ra": {"atomic_number": 88, "symbol": "Ra",
           "atomic_mass": None, "name": "radium"},
    "Ac": {"atomic_number": 89, "symbol": "Ac",
           "atomic_mass": None, "name": "actinium"},
    ...
    "Np": {"atomic_number": 93, "symbol": "Np",
           "atomic_mass": None, "name": "neptunium"},
    "Pu": {"atomic_number": 94, "symbol": "Pu",
           "atomic_mass": None, "name": "plutonium"},
    "Am": {"atomic_number": 95, "symbol": "Am",
           "atomic_mass": None, "name": "americium"},
    "Cm": {"atomic_number": 96, "symbol": "Cm",
           "atomic_mass": None, "name": "curium"},
    "Bk": {"atomic_number": 97, "symbol": "Bk",
           "atomic_mass": None, "name": "berkelium"},
    "Cf": {"atomic_number": 98, "symbol": "Cf",
           "atomic_mass": None, "name": "californium"},
    "Es": {"atomic_number": 99, "symbol": "Es",
           "atomic_mass": None, "name": "einsteinium"},
    "Fm": {"atomic_number": 100, "symbol": "Fm",
           "atomic_mass": None, "name": "fermium"},
    "Md": {"atomic_number": 101, "symbol": "Md",
           "atomic_mass": None, "name": "mendelevium"},
    "No": {"atomic_number": 102, "symbol": "No",
           "atomic_mass": None, "name": "nobelium"},
    "Lr": {"atomic_number": 103, "symbol": "Lr",
           "atomic_mass": None, "name": "lawrencium"},
    "Rf": {"atomic_number": 104, "symbol": "Rf",
           "atomic_mass": None, "name": "rutherfordium"},
    "Db": {"atomic_number": 105, "symbol": "Db",
           "atomic_mass": None, "name": "dubnium"},
    "Sg": {"atomic_number": 106, "symbol": "Sg",
           "atomic_mass": None, "name": "seaborgium"},
    "Bh": {"atomic_number": 107, "symbol": "Bh",
           "atomic_mass": None, "name": "bohrium"},
    "Hs": {"atomic_number": 108, "symbol": "Hs",
           "atomic_mass": None, "name": "hassium"},
    "Mt": {"atomic_number": 109, "symbol": "Mt",
           "atomic_mass": None, "name": "meitnerium"},
    "Ds": {"atomic_number": 110, "symbol": "Ds",
           "atomic_mass": None, "name": "darmstadtium"},
    "Rg": {"atomic_number": 111, "symbol": "Rg",
           "atomic_mass": None, "name": "roentgenium"},
    "Cn": {"atomic_number": 112, "symbol": "Cn",
           "atomic_mass": None, "name": "copernicium"},
    "Nh": {"atomic_number": 113, "symbol": "Nh",
           "atomic_mass": None, "name": "nihonium"},
    "Fl": {"atomic_number": 114, "symbol": "Fl",
           "atomic_mass": None, "name": "flerovium"},
    "Mc": {"atomic_number": 115, "symbol": "Mc",
           "atomic_mass": None, "name": "moscovium"},
    "Lv": {"atomic_number": 116, "symbol": "Lv",
           "atomic_mass": None, "name": "livermorium"},
    "Ts": {"atomic_number": 117, "symbol": "Ts",
           "atomic_mass": None, "name": "tennessine"},
    "Og": {"atomic_number": 118, "symbol": "Og",
           "atomic_mass": None, "name": "oganesson"},
    }
