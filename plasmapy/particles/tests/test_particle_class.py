...
def test_custom_particles_from_json(cls, kwargs, json_string, expected_exception):
...
def test_particles_from_json(cls, kwargs, json_string, expected_exception):
...
def test_particle_json_repr(cls, kwargs, expected_repr):
