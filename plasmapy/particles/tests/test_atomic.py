...
test_cases = [
    ...
    FunctionTestCase(function=atomic_symbol, args="Og-294b", expected=InvalidParticleError),
    FunctionTestCase(function=atomic_symbol, args="H-93436107932635", expected=InvalidParticleError),
    FunctionTestCase(function=atomic_symbol, args="Fe 2+4", expected=InvalidParticleError),
    FunctionTestCase(function=atomic_symbol, args="Fe+24", expected=InvalidParticleError),
    FunctionTestCase(function=atomic_symbol, args="Fe +59", expected=InvalidParticleError),
    FunctionTestCase(function=atomic_symbol, args="C++++++++++++++++", expected=InvalidParticleError),
    FunctionTestCase(function=atomic_symbol, args="C-++++", expected=InvalidParticleError),
    FunctionTestCase(function=atomic_symbol, args="neutron", expected=InvalidElementError),
    ...
    FunctionTestCase(function=atomic_symbol, args="antiproton", expected=InvalidElementError),
    ...
    FunctionTestCase(function=isotope_symbol, args="Md-260", kwargs={"mass_numb": 261}, expected=InvalidParticleError),
    FunctionTestCase(function=isotope_symbol, args="protium", kwargs={"mass_numb": 2}, expected=InvalidParticleError),
    FunctionTestCase(function=isotope_symbol, args="alpha", kwargs={"mass_numb": 3}, expected=InvalidParticleError),
    FunctionTestCase(function=isotope_symbol, args="O-18", kwargs={"mass_numb": 19}, expected=InvalidParticleError),
    FunctionTestCase(function=isotope_symbol, args="lead-209", kwargs={"mass_numb": 511}, expected=InvalidParticleError),
    FunctionTestCase(function=isotope_symbol, args="He-1", expected=InvalidParticleError),
    FunctionTestCase(function=isotope_symbol, args=24, kwargs={"mass_numb": 23}, expected=InvalidParticleError),
    FunctionTestCase(function=isotope_symbol, args="H", kwargs={"mass_numb": 0}, expected=InvalidParticleError),
    FunctionTestCase(function=isotope_symbol, args="H-1", kwargs={"mass_numb": 2}, expected=InvalidParticleError),
    ...
    FunctionTestCase(function=isotope_symbol, args="hydrogen-444444", expected=InvalidParticleError),
    FunctionTestCase(function=isotope_symbol, args="Fe", kwargs={"mass_numb": 2.1}, expected=TypeError),
    FunctionTestCase(function=isotope_symbol, args="He", kwargs={"mass_numb": "c"}, expected=TypeError),
    FunctionTestCase(function=isotope_symbol, args="He-3", kwargs={"mass_numb": 4}, expected=InvalidParticleError),
    FunctionTestCase(function=isotope_symbol, args="D", kwargs={"mass_numb": 3}, expected=InvalidParticleError),
    FunctionTestCase(function=isotope_symbol, args="T", kwargs={"mass_numb": 2}, expected=InvalidParticleError),
    FunctionTestCase(function=isotope_symbol, args="Fe", kwargs={"mass_numb": None}, expected=InvalidIsotopeError),
    FunctionTestCase(function=isotope_symbol, args="He", kwargs={"mass_numb": 99}, expected=InvalidParticleError),
    FunctionTestCase(function=isotope_symbol, args="d", expected=InvalidParticleError),
    FunctionTestCase(function=isotope_symbol, args="h-3", expected=InvalidParticleError),
    FunctionTestCase(function=isotope_symbol, args="h", expected=InvalidParticleError),
    FunctionTestCase(function=isotope_symbol, args="d+", expected=InvalidParticleError),
    FunctionTestCase(function=isotope_symbol, args="H-1", kwargs={"mass_numb": 1}, expected=AtomicWarning),
    FunctionTestCase(function=isotope_symbol, args="H-2", kwargs={"mass_numb": 2}, expected=AtomicWarning),
    FunctionTestCase(function=isotope_symbol, args="T", kwargs={"mass_numb": 3}, expected=AtomicWarning),
    FunctionTestCase(function=isotope_symbol, args="Li-6", kwargs={"mass_numb": 6}, expected=AtomicWarning),
    FunctionTestCase(function=isotope_symbol, args="lithium-6", kwargs={"mass_numb": 6}, expected=AtomicWarning),
    FunctionTestCase(function=isotope_symbol, args="alpha", kwargs={"mass_numb": 4}, expected=AtomicWarning),
    FunctionTestCase(function=isotope_symbol, args="p", kwargs={"mass_numb": 1}, expected=AtomicWarning),
    ...
    FunctionTestCase(function=atomic_number, args="N+++", expected=7),
    FunctionTestCase(function=atomic_number, args="H-3934", expected=InvalidParticleError),
    FunctionTestCase(function=atomic_number, args="C-12b", expected=InvalidParticleError),
    ...
    FunctionTestCase(function=atomic_number, args="neutron", expected=InvalidElementError),
    FunctionTestCase(function=atomic_number, args="Neutron", expected=InvalidElementError),
    ...
    FunctionTestCase(function=atomic_number, args="s-36", expected=InvalidParticleError),
    ...
    FunctionTestCase(function=mass_number, args="N-13+-+-", expected=InvalidParticleError),
    ...
    FunctionTestCase(function=element_name, args="N+++", expected="nitrogen"),
    FunctionTestCase(function=element_name, args="D-", expected="hydrogen"),
    FunctionTestCase(function=element_name, args="vegancupcakes", expected=InvalidParticleError),
    ...
    FunctionTestCase(function=element_name, args="neutron", expected=InvalidElementError),
    ...
    FunctionTestCase(function=standard_atomic_weight, args="H", expected=(1.008 * u.u).to(u.kg)),
    FunctionTestCase(function=standard_atomic_weight, args=1, expected=(1.008 * u.u).to(u.kg)),
    FunctionTestCase(function=standard_atomic_weight, args="Hydrogen", expected=(1.008 * u.u).to(u.kg)),
    ...
    FunctionTestCase(function=standard_atomic_weight, args="n", expected=InvalidElementError),
    FunctionTestCase(function=standard_atomic_weight, args="p", expected=AtomicError),
    FunctionTestCase(function=standard_atomic_weight, args="alpha", expected=AtomicError),
    FunctionTestCase(function=standard_atomic_weight, args="deuteron", expected=AtomicError),
    FunctionTestCase(function=standard_atomic_weight, args="tritium", expected=AtomicError),
    FunctionTestCase(function=standard_atomic_weight, args="Au+", expected=AtomicError),
    FunctionTestCase(function=standard_atomic_weight, args="Fe -2", expected=AtomicError),
    FunctionTestCase(function=standard_atomic_weight, args="Og 2+", expected=AtomicError),
    FunctionTestCase(function=standard_atomic_weight, args="h", expected=InvalidParticleError),
    FunctionTestCase(function=standard_atomic_weight, args="fe", expected=InvalidParticleError),
    FunctionTestCase(function=particle_mass, args="proton", expected=const.m_p.to("kg")),
    FunctionTestCase(function=particle_mass, args="H-1+", expected=const.m_p.to("kg")),
    FunctionTestCase(function=particle_mass, args="H-1 +1", expected=const.m_p.to("kg")),
    FunctionTestCase(function=particle_mass, args="H-1 1+", expected=const.m_p.to("kg")),
    FunctionTestCase(function=particle_mass, args="H-1", kwargs={"Z": 1}, expected=const.m_p.to("kg")),
    FunctionTestCase(function=particle_mass, args="hydrogen-1", kwargs={"Z": 1}, expected=const.m_p.to("kg")),
    ...
    FunctionTestCase(function=particle_mass, args="Og 1+", expected=MissingAtomicDataError),
    FunctionTestCase(function=particle_mass, args="Fe-56", kwargs={"Z": 1.4}, expected=TypeError),
    FunctionTestCase(function=particle_mass, args="H-1 +1", kwargs={"Z": 0}, expected=InvalidParticleError),
    FunctionTestCase(function=particle_mass, args=26, kwargs={"Z": 1, "mass_numb": "a"}, expected=TypeError),
    FunctionTestCase(function=particle_mass, args=26, kwargs={"Z": 27, "mass_numb": 56}, expected=InvalidParticleError),
    FunctionTestCase(function=particle_mass, args="Og", kwargs={"Z": 1}, expected=MissingAtomicDataError),
    FunctionTestCase(function=particle_mass, args="Og", kwargs={"mass_numb": 696, "Z": 1}, expected=InvalidParticleError),
    FunctionTestCase(function=particle_mass, args="He 1+", kwargs={"mass_numb": 99}, expected=InvalidParticleError),
    FunctionTestCase(function=particle_mass, args="fe-56 1+", expected=InvalidParticleError),
    FunctionTestCase(function=particle_mass, args="H-1", kwargs={"mass_numb": 1, "Z": 1}, expected=AtomicWarning),
    FunctionTestCase(function=particle_mass, args="H", expected=standard_atomic_weight("H")),
    ...
    FunctionTestCase(function=is_stable, args="Fe", kwargs={"mass_numb": 56}, expected=True),
    ...
    FunctionTestCase(function=is_stable, args="Lead-209", expected=False),
    FunctionTestCase(function=is_stable, args="Pb", kwargs={"mass_numb": 209}, expected=False),
    FunctionTestCase(function=is_stable, args=(82, 209), expected=False),
    FunctionTestCase(function=is_stable, args=("hydrogen-444444",), expected=InvalidParticleError),
    FunctionTestCase(function=is_stable, args=("hydrogen", 0), expected=InvalidParticleError),
    FunctionTestCase(function=is_stable, args=("",), expected=InvalidParticleError),
    FunctionTestCase(function=is_stable, args=("pb-209",), expected=InvalidParticleError),
    ...
    FunctionTestCase(function=integer_charge, args="fads", expected=InvalidParticleError),
    FunctionTestCase(function=integer_charge, args="H++", expected=InvalidParticleError),
    FunctionTestCase(function=integer_charge, args="h+", expected=InvalidParticleError),
    FunctionTestCase(function=integer_charge, args="fe 1+", expected=InvalidParticleError),
    FunctionTestCase(function=integer_charge, args="d+", expected=InvalidParticleError),
    FunctionTestCase(function=integer_charge, args="Fe 29+", expected=InvalidParticleError),
    ...
    FunctionTestCase(function=electric_charge, args="e", expected=-1.6021766208e-19 * u.C),
    FunctionTestCase(function=electric_charge, args="alpha", expected=3.2043532416e-19 * u.C),
    FunctionTestCase(function=electric_charge, args="n", expected=0 * u.C),
    FunctionTestCase(function=electric_charge, args="bad input", expected=InvalidParticleError),
    FunctionTestCase(function=electric_charge, args="h+", expected=InvalidParticleError),
    FunctionTestCase(function=electric_charge, args="Au 81+", expected=InvalidParticleError),
    ...
    FunctionTestCase(function=half_life, args="No-248", expected=MissingAtomicDataError),  # isotope with missing data
    FunctionTestCase(function=periodic_table_period, args=("Ne", "Na"), expected=TypeError),
    FunctionTestCase(function=periodic_table_block, args=("N", "C", "F"), expected=TypeError),
    FunctionTestCase(function=periodic_table_category, args=("Rb", "He", "Li"), expected=TypeError),
    FunctionTestCase(function=periodic_table_group, args=("B", "Ti", "Ge"), expected=TypeError),
    FunctionTestCase(function=isotopic_abundance, args=("H", 1), expected=isotopic_abundance("protium")),
    ...
    FunctionTestCase(function=isotopic_abundance, args=("Og", 294), expected=AtomicWarning),
    FunctionTestCase(function=isotopic_abundance, args="neutron", expected=InvalidIsotopeError),
    FunctionTestCase(function=isotopic_abundance, args="Og-2", expected=InvalidParticleError),
    FunctionTestCase(function=particle_mass, args="berkelium-249", expected=(249.0749877 * u.u).to("kg")),
    ...
    FunctionTestCase(function=reduced_mass, args=("N", 6e-26 * u.l), expected=u.UnitConversionError),
    FunctionTestCase(function=reduced_mass, args=("Og", "H"), expected=MissingAtomicDataError),
    FunctionTestCase(function=known_isotopes, args="H", expected=["H-1", "D", "T", "H-4", "H-5", "H-6", "H-7"]),
...
def append_invalid_particle_tests(list_of_tests):
    ...
    for function in functions_to_test:
        for invalid_particle, exception in invalid_particles_and_exceptions:
            list_of_tests.append(FunctionTestCase(function=function, args=invalid_particle, expected=exception))
