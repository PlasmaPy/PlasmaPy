...
class ParticleInput:
    ...
    def as_decorator(cls, func=None, **kwargs):
        """
        Transform arguments decorated with `~plasmapy.particles.ParticleLike`
        to `~plasmapy.particles.Particle`, `~plasmapy.particles.CustomParticle`,
        or `~plasmapy.particles.ParticleList` instances.
...
particle_input = ParticleInput.as_decorator
