...
from plasmapy.physics import exceptions
...
class Test_Coulomb_logarithm:
    ...
    def test_handle_invalid_V(self):
        ...
        methodVal_2 = Coulomb_logarithm(
            self.T_arr[0], self.n_arr[0], self.particles, z_mean=1 * u.dimensionless_unscaled
        )
    ...
    def test_Chen_Q_machine(self):
        ...
        errStr = (
            "Q-machine value of Coulomb logarithm should be " f"{lnLambdaChen} and not {lnLambda}."
        )
    ...
    def test_Chen_torus(self):
        ...
        testTrue = np.isclose(lnLambda, lnLambdaChen, rtol=1e-1, atol=0.0)
        errStr = (
            "Torus value of Coulomb logarithm should be " f"{lnLambdaChen} and not {lnLambda}."
        )
        assert testTrue, errStr
    ...
    def test_GMS1(self):
        ...
        testTrue = np.isclose(methodVal, self.gms1, rtol=1e-15, atol=0.0)
        errStr = f"Coulomb logarithm for GMS-1 should be " f"{self.gms1} and not {methodVal}."
        assert testTrue, errStr
    ...
    def test_GMS2(self):
        ...
        testTrue = np.isclose(methodVal, self.gms2, rtol=1e-15, atol=0.0)
        errStr = f"Coulomb logarithm for GMS-2 should be " f"{self.gms2} and not {methodVal}."
        assert testTrue, errStr
    ...
    def test_GMS3(self):
        ...
        testTrue = np.isclose(methodVal, self.gms3, rtol=1e-15, atol=0.0)
        errStr = f"Coulomb logarithm for GMS-3 should be " f"{self.gms3} and not {methodVal}."
        assert testTrue, errStr
    ...
    def test_GMS3_negative(self):
        ...
        testTrue = np.isclose(methodVal, self.gms3_negative, rtol=1e-15, atol=0.0)
        errStr = (
            f"Coulomb logarithm for GMS-3 should be " f"{self.gms3_negative} and not {methodVal}."
        )
        assert testTrue, errStr
    ...
    def test_GMS3_non_scalar_density(self):
        ...
        testTrue = np.isclose(methodVal, self.gms3_non_scalar, rtol=1e-15, atol=0.0)
        errStr = (
    ...
    def test_GMS4(self):
        ...
        testTrue = np.isclose(methodVal, self.gms4, rtol=1e-15, atol=0.0)
        errStr = f"Coulomb logarithm for GMS-4 should be " f"{self.gms4} and not {methodVal}."
        assert testTrue, errStr
    ...
    def test_GMS4_negative(self):
        ...
        testTrue = np.isclose(methodVal, self.gms4_negative, rtol=1e-15, atol=0.0)
        errStr = (
            f"Coulomb logarithm for GMS-4 should be " f"{self.gms4_negative} and not {methodVal}."
        )
        assert testTrue, errStr
    ...
    def test_GMS5(self):
        ...
        testTrue = np.isclose(methodVal, self.gms5, rtol=1e-15, atol=0.0)
        errStr = f"Coulomb logarithm for GMS-5 should be " f"{self.gms5} and not {methodVal}."
        assert testTrue, errStr
    ...
    def test_GMS5_negative(self):
        ...
        testTrue = np.isclose(methodVal, self.gms5_negative, rtol=1e-15, atol=0.0)
        errStr = (
            f"Coulomb logarithm for GMS-5 should be " f"{self.gms5_negative} and not {methodVal}."
        )
        assert testTrue, errStr
    ...
    def test_GMS6(self):
        ...
        errStr = f"Coulomb logarithm for GMS-6 should be " f"{self.gms6} and not {methodVal}."
        assert testTrue, errStr
    ...
    def test_GMS6_negative(self):
        ...
        testTrue = np.isclose(methodVal, self.gms6_negative, rtol=1e-15, atol=0.0)
        errStr = (
            f"Coulomb logarithm for GMS-6 should be " f"{self.gms6_negative} and not {methodVal}."
        )
        assert testTrue, errStr
    ...
    def test_unit_conversion_error(self):
        ...
        with pytest.raises(u.UnitConversionError):
            Coulomb_logarithm(1e5 * u.g, 1 * u.m ** -3, ("e", "p"), V=29979245 * u.m / u.s)
...
class Test_impact_parameter_perp:
    ...
    def test_handle_nparrays(self, insert_some_nans, insert_all_nans, kwargs={}):
        """Test for ability to handle numpy array quantities"""
        assert_can_handle_nparray(impact_parameter_perp, insert_some_nans, insert_all_nans, kwargs)
...
class Test_collision_frequency:
    ...
    @pytest.mark.parametrize("insert_all_nans", [[], ["V"]])
    @pytest.mark.parametrize(
        "kwargs", [{"particles": ("e", "e")}, {"particles": ("e", "p")}, {"particles": ("p", "p")}]
    )
    def test_handle_nparrays(self, insert_some_nans, insert_all_nans, kwargs):
        """Test for ability to handle numpy array quantities"""
    ...
    def test_electrons(self):
        ...
        testTrue = np.isclose(self.True_electrons, methodVal.si.value, rtol=1e-1, atol=0.0)
        errStr = f"Collision frequency should be {self.True_electrons} and " f"not {methodVal}."
        assert testTrue, errStr
    ...
    def test_protons(self):
        ...
        testTrue = np.isclose(self.True_protons, methodVal.si.value, rtol=1e-1, atol=0.0)
        errStr = f"Collision frequency should be {self.True_protons} and " f"not {methodVal}."
        assert testTrue, errStr
    ...
    def test_zmean(self):
        ...
        errStr = f"Collision frequency should be {self.True_zmean} and " f"not {methodVal}."
        assert testTrue, errStr
...
class Test_fundamental_electron_collision_freq:
    ...
    def test_handle_nparrays(self, insert_some_nans, insert_all_nans, kwargs={}):
        ...
        assert_can_handle_nparray(
            fundamental_electron_collision_freq, insert_some_nans, insert_all_nans, kwargs
        )
...
class Test_fundamental_ion_collision_freq:
    ...
    def test_handle_nparrays(self, insert_some_nans, insert_all_nans, kwargs={}):
        """Test for ability to handle numpy array quantities"""
        assert_can_handle_nparray(
            fundamental_ion_collision_freq, insert_some_nans, insert_all_nans, kwargs
        )
...
class Test_mean_free_path:
    ...
    def test_fail1(self):
        ...
        testTrue = not np.isclose(methodVal.si.value, fail1, rtol=1e-16, atol=0.0)
        errStr = (
            f"Mean free path value test gives {methodVal} and " f"should not be equal to {fail1}."
        )
        assert testTrue, errStr
...
class Test_Spitzer_resistivity:
    ...
    def test_zmean(self):
        ...
        testTrue = np.isclose(self.True_zmean, methodVal.si.value, rtol=1e-1, atol=0.0)
        errStr = f"Spitzer resistivity should be {self.True_zmean} and " f"not {methodVal}."
        assert testTrue, errStr
...
class Test_mobility:
    ...
    def test_fail1(self):
        ...
        testTrue = not np.isclose(methodVal.si.value, fail1, rtol=1e-16, atol=0.0)
        errStr = f"Mobility value test gives {methodVal} and " f"should not be equal to {fail1}."
        assert testTrue, errStr
...
class Test_Knudsen_number:
    ...
    def test_fail1(self):
        ...
        errStr = (
            f"Knudsen number value test gives {methodVal} and " f"should not be equal to {fail1}."
        )
        assert testTrue, errStr
...
class Test_coupling_parameter:
    ...
    def test_zmean(self):
        ...
        errStr = f"Coupling parameter should be {self.True_zmean} and " f"not {methodVal}."
        assert testTrue, errStr
    ...
    def test_handle_nparrays(self, insert_some_nans, insert_all_nans, kwargs={}):
        """Test for ability to handle numpy array quantities"""
        assert_can_handle_nparray(coupling_parameter, insert_some_nans, insert_all_nans, kwargs)

    def test_quantum(self):
        """
        Testing quantum method for coupling parameter.
        """
        methodVal = coupling_parameter(self.T, self.n_e, self.particles, method="quantum")
        testTrue = np.isclose(self.True_quantum, methodVal, rtol=1e-1, atol=0.0)
        errStr = f"Coupling parameter should be {self.True_quantum} and " f"not {methodVal}."
        assert testTrue, errStr
