...
#TODO: interface for inputting a multi-species configuration could be simplified
#using the plasmapy.classes.plasma_base class if that class included ion and
#electron drift velocities and information about the ion atomic species. 
...
def spectral_density(wavelength, probe_wavelength=532*u.nm, ne=1e15*u.cm**-3,
    ...
    re= 2.8179e-13*u.cm #classical electron radius
    ...
    ni = fract*ne/ion_z #Density of each ion component
