...
class ChargedParticleRadiographyTracker(ParticleTracker):
    r"""
...
def synthetic_radiograph(  # noqa: C901
    ...
    # condition `obj` input
    if isinstance(obj, ChargedParticleRadiographyTracker):
        ...
        raise TypeError(
            f"Expected type dict or {ChargedParticleRadiographyTracker} for argument `obj`, but "
            f"got type {type(obj)}."
        )
