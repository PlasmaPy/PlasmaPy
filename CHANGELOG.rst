...
- In `plasmapy.dispersion`, the ``z_mean`` parameter
  ...
  deprecated. Provide the |charge number| to ``Z`` instead. (:pr:`2022`)
- When a function decorated with |particle_input| is provided with
  ...
  decorated with |particle_input|. (:pr:`2027`)
- The ``z_mean`` parameter to `~plasmapy.formulary.speeds.ion_sound_speed`
  has been deprecated and may be removed in a future release. (:pr:`2134`)
...
- The function `~plasmapy.dispersion.analytical.two_fluid_.two_fluid`
  ...
  argument for the mass number corresponding to the ion. (:pr:`2022`)
- Decorated `~plasmapy.formulary.frequencies.plasma_frequency` with
  |particle_input| so that it can now accept a broader variety of
  |particle-like| arguments. (:pr:`2026`)
...
- Decorated `~plasmapy.formulary.speeds.ion_sound_speed` with
  |particle_input| so that it can accept a broader variety of
  |particle-like| arguments. (:pr:`2134`)
- Decorated `~plasmapy.formulary.speeds.kappa_thermal_speed` with
  |particle_input| so that it can accept a broader variety of
  |particle-like| arguments. (:pr:`2136`)
...
- Decorated `~plasmapy.formulary.speeds.Alfven_speed` with
  |particle_input| so that it can now accept a broader variety of
  |particle-like| arguments. (:pr:`2179`)
- The function `~plasmapy.dispersion.numerical.hollweg_.hollweg`
  ...
  |particle-like| arguments that can be provided to this function. (:pr:`2181`)
- The function `~plasmapy.dispersion.numerical.kinetic_alfven_.kinetic_alfven`
  has been decorated with |particle_input| to broaden the range of
  |particle-like| arguments that can be provided to this function. (:pr:`2182`)
