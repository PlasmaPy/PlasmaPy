...
class ParticleTracker:
    ...
    def fract_entered(self):
        ...
        """
        return (self.num_entered - self.nparticles_removed - 
                self.nparticles_stopped) / self.nparticles_tracked
    ...
    def _update_velocity_stopping(self, summed_field_values) -> None:
        ...
        # Eliminate negative energies before calcualting new speeds
        E = np.where(E<0, 0, E)
