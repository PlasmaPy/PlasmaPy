...
.. note::
    ...
    This README was adapted from the SunPy changelog readme under the terms of the BSD 2-Clause licence.
...
The ``CHANGELOG`` will be read by users, so this description should be aimed at PlasmaPy users instead of describing internal changes which are only relevant to the developers.
