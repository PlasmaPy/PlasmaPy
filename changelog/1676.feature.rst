Added the `~plasmapy.formulary.collisions.SingleParticleCollisionFrequencies` class. This class can be used to calculate collision frequencies for two interacting plasmas.
